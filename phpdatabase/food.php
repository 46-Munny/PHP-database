...
<div class="">
      <p class="text-center mt-3">If you want to create your own profile?<a href="#">click here</a></p><br>
</div>
<div class="row">
  <?php
  ...
  if($con)
  {
   ...
   if(isset($_POST['submit']))
   {
    ...
    /*  $filename=$files['name'];
      ...
      $query=mysqli_query($con,"insert into openfood values('$id','$username','$profilename','$address','$phnNo','$email')");
  ...
  <a href="<?php echo $result['foodPage'].'.php'; ?>" class="button1 btn btn-primary text-center">More Foods</a>
